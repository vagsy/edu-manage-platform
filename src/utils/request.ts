...
request.interceptors.response.use(function (response) { // 状态码为2xx 都会进入这里
  // 如果是自定义错误状态码，错误处理就写到这里
  return response
}, function (error) { // 超出 2xx 状态都执行这里
  ...
  } else if (error.request) { // 请求发出去没有收的响应
